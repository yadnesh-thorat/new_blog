...
export const VisitorFooter = () => {
  ...
  return (
    <footer className="border-t border-border/40 text-muted-foreground font-marathi-body bg-background">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <div className="md:col-span-4 space-y-4">
            <div className="flex flex-col items-center md:items-start gap-3 text-center md:text-left">
              {settings?.logoImage ? (
                <div className="h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 rounded-full overflow-hidden bg-white flex items-center justify-center shadow-sm">
                  <img src={settings.logoImage} alt={siteName} className="h-full w-full object-contain" />
                </div>
              ) : null}
              <div>
            ...
            {/* Social links */}
            <div className="flex gap-3.5 pt-2 justify-center md:justify-start flex-wrap">
              {settings?.contactInfo?.socialLinks?.twitter && (
                <a
                  href={settings.contactInfo.socialLinks.twitter}
                  target="_blank"
                  rel="noreferrer"
                  className="w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center border-2 border-border hover:border-primary bg-card/80 rounded-full text-foreground hover:text-primary transition-all hover:scale-110 shadow-xs group"
